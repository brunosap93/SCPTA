sap.ui.define([
    ...
    return BaseController.extend("ns.IncidentReportIXXXXXX.controller.Create", {
       ...
       onAfterRendering: function () {
        ...
        onSave: function () {
			...
			if (data.title != "" && data.description != "") {
				...
				var settings = {
					async: true,
					url: "/nsIncidentReportIXXXXXX/Incidents_CF/incident/SafetyIncidents",
					method: "POST",
					headers: {
        ...
        createPicture: function (response) {
			...
			var settings = {
				async: true,
				crossDomain: true,
				url: "/nsIncidentReportIXXXXXX/Incidents_CF/incident/IncidentPhotos",
				"method": "POST",
				"timeout": 0,
				"headers": {
					"content-type": "application/json"
		...
		uploadPicture: function (response) {
			...
			xhr.open("PUT", "/nsIncidentReportIXXXXXX/Incidents_CF/incident/IncidentPhotos(" + id + ")/image");
